  ...
  <div class="row mt-5">
    <div class="col-lg-2 col-md-4 col-sm-4 col-xs-12 ">
      <div class="container-rightmenu mx-auto p-4" >
        <ul>
          <li><a class="active" href="#home">รายการสินค้า</a></li>
          <li><a href="#news">ข้าวหอมมะลิ</a></li>
          <li><a href="#contact">ข้าวเหนียว</a></li>
          <li><a href="#about">ของชำร่วย</a></li>
        </ul>
      </div>
    ...
    <div class="col-lg-10 col-md-8 col-sm-8 col-xs-12" style="background-color: #f5f5f5;">
      <div class="row">
        ...
        $products = $productObj->getAllProductJS();
        foreach ($products as $product) {
        ?>
          <div class="col-sm-4 col-4 ml-5 d-flex justify-content-center"> <!--***แสดงข้อมูลแบบ 3 3 3 3***-->
