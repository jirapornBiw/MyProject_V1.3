...
<footer class="text-center text-lg-start bg-light text-muted">
    ...
    <div class="container text-center text-md-start mt-5">
      ...
      <div class="row mt-3">
        ...
        <div class="col-md-2 col-lg-2 col-xl-2 mx-auto mb-4">
          ...
          <p>
          <p><i class="fa fa-home me-3"></i> หมู่บ้าน บ้านกอก ต.โนนธาตุ อ.หนองสองห้อง จ.ขอนแก่น</p>
          </p>
        ...
        <div class="col-md-2 col-lg-2 col-xl-2 mx-auto mb-4">
          ...
          <p>
          <p><i class="fa fa-clock-o"></i> จ-ศ 09:00-14:00</p>
          </p>
          <p>
          <p><i class="fa fa-clock-o"></i> หยุดทุกวัน ส-อา</p>
          </p>
        ...
        <div class="col-md-4 col-lg-3 col-xl-3 mx-auto mb-md-0 mb-4">
          ...
          <p><i class="fa fa-phone me-3"></i> 095 395 4854</p>
        </div>
        <!-- Grid column -->
      </div>
      <!-- Grid row -->
  ...
  <!-- Copyright -->
  <div class="text-center text-light p-4" style="background-color: #a65729;">
    © 2022 Copyright:
