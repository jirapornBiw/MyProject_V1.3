                    ...
                    <div class="col-lg-8 m-auto">
                        ...
                        <div class="carousel slide" id="slider1" data-bs-ride="carousel">
                                ...
                                <div class="carousel-inner">
                                    ...
                                    <img src="https://www.diamondtime.biz/watch2home/farmerhat22.jpg" class="d-block w-100">
                                        <div class="carousel-caption d-none d-md-block">
                ...
                <div class="col">
                    <div class="row">
                        <div class="col-sm-4 ml-5">
                            ...
                            <img src="../../img/pro230f4.png" width="300px">
                            </div>
                        ...
                        <div class="col-sm-4 ml-5">
                            <div class="d-flex justify-content-center">
                            <img src="../../img/pro15e1f.png" width="300px">
                            </div>
                            <div class="container text-center">
                                <h4>ข้าวขาวเสาไห้</h4>
                            </div>
                        ...
                        <div class="col-sm-4 ml-5">
                            <div class="d-flex justify-content-center">
                            <img src="../../img/pro3.png" width="300px">
                            </div>
                            <div class="container text-center">
                                <h4>ข้าวเหนียว</h4>
                            </div>
        ...
        <div class="row mt-5">
            <div class="col text-center">
                <a href="products.php?id=<?php
                        echo"{$_SESSION['c_id']}";?>" class="btn btn-success btn-sm" style="width:15%">ดูสินค้าทั้งหมด</a>
