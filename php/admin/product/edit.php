                            ...
                            <div class="card-body d-flex justify-content-center">
                                <form action="save_add.php?action=add" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group mb-2">
                                        ...
                                        <input type="hidden" name="image" id="txt_file" class="form-contro" value="<?php echo $product['image']; ?>" required>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        ";
                                            ...
                                            <div class="form-group mb-2">
                                                ...
                                                <input type="text" name="price" id="price" class="form-contro" style="width: 400px;" value="<?php echo $product['price']; ?>" required>
                                            </div>
                                            <div class="form-group mb-2">
                                                <label for="Products_Detail">รายละเอียด</label></br>
                                                <textarea placeholder="" style="width: 400px ;height:100px;" type="text" name="Products_Detail" id="Products_Detail" class="form-contro" required><?php echo $product['Products_Detail']; ?></textarea>
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                            <div class="form-group mb-2">
                                                <label for="name">ชื่อพันธุ์ข้าว</label></br>
                                                <input type="text" name="name" id="name" class="form-control" style="width: 400px;" value="<?php echo $product['name']; ?>" required>
                                            </div>

                                            <div class="form-group mb-2">
                                                <label for="stock">จำนวนในสต็อก (ถุง)</label></br>
                                                <input type="text" name="stock" id="stock" class="form-contro" style="width: 400px;" value="<?php echo $product['stock']; ?>" required>
                                            </div>
