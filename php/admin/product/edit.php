			...
			<div class="col">
				<div class="card mb-3">
                    ...
                    <div class="form-group">
                        ...
                        <textarea placeholder=""style="width: 400px ;height:300px;" type="text" name="Products_Detail" id="Products_Detail" class="form-contro"><?php echo $product['Products_Detail'];?></textarea>
                    </div></br>
