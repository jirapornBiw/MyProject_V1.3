...
$orders = $ordersObj->getNewOrders();
include("../connect.php");
$query = mysqli_query($conn, "SELECT COUNT(o_id) FROM orders WHERE status = 'รอการชำระเงิน' ");
						...
						<div class="card mb-3 ">
							...
							<div class="row mt-4">
								<div class="col-8">
									...
									<a href='#.php' class='btn btn-outline-warning'>รายการใหม่</a>
								...
								<table class="table">
									...
									<tbody>
										...
										<tr>    
											...
											<td>
											<a href='orderDetail.php?id={$order['o_id']}&action=detailN' class='btn btn-outline-warning'>รายละเอียด</a>
											</td>
										</tr>
										";
											}
